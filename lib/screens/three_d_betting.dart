...
class ThreeDBettingPage extends StatefulWidget {
  const ThreeDBettingPage({super.key});

  @override
  State<ThreeDBettingPage> createState() => _ThreeDBettingPageState();
}

class _ThreeDBettingPageState extends State<ThreeDBettingPage> {
    ...
    setState(() {
      ...
      switch (option) {
        case 'အပေါ်ဆုံး 10 လုံး':
          _selectedNumbers.addAll(['000', '001', '002', '003', '004', '005', '006', '007', '008', '009']);
          break;
        case 'အောက်ဆုံး 10 လုံး':
          _selectedNumbers.addAll(['990', '991', '992', '993', '994', '995', '996', '997', '998', '999']);
          break;
        case 'အလယ်က 10 လုံး':
          _selectedNumbers.addAll(['495', '496', '497', '498', '499', '500', '501', '502', '503', '504']);
          break;
        case 'အပေါ်ဆုံး 20 လုံး':
          for (int i = 0; i <= 19; i++) {
            _selectedNumbers.add(i.toString().padLeft(3, '0'));
          }
          break;
                    ...
                    Expanded(
                      child: GridView.builder(
                        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                          crossAxisCount: 8, // 8 columns for 3D numbers (000-999)
                          crossAxisSpacing: 3,
                          mainAxisSpacing: 3,
                          childAspectRatio: 1.2,
                        ),
                        itemCount: 1000, // 000 to 999
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontSize: 10, // Smaller font for 3-digit numbers
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                              ),
